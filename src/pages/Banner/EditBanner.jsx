...
function EditBanner() {
  ...
  return (
    <div className="">
        <div className='text-2xl font-bold capitalize flex py-4 underline text-blue-900'>Edit Banner</div>
    <div>
    {
        ...
        image:"",
        type:Data.length>0?Data[0]?.type:"",
        }}
        ...
        onSubmit={(values,{resetForm}) => {
          ...
          setSubmitted(true)
            ...
            axios.patch(`/banner/${id}`,formData).then(res=>{
              console.log(res)
              setSubmitted(false)
              navigate(-1)
