      ...
      <div className="flex justify-between items-center px-6 h-14">
        ...
        <div className="flex items-center gap-6 h-full">
          ...
          <div className="relative h-full flex items-center">
            ...
            <div
              ref={dropdownRef}
              className={`absolute top-full right-0 text-left bg-white shadow py-2 w-52 transition-all duration-800 ease-in border ${
            ...
            >
              ...
              <ul className="flex flex-col px-4">
                <li className="py-1">
                  <Link
                    to={"/account/settings"}
                    className="text-blue-600 leading-7 flex gap-3 items-center text-sm font-medium"
                  >
